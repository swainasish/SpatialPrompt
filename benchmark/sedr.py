...
#%%
os.chdir("/home/swainasish/Downloads/SEDR")
...
t2= time.time()
print(t2-t1)
sc.pl.spatial(adata_sedr,color="SEDR_leiden")
sedr_prediction = pd.DataFrame(np.array(adata_sedr.obs.SEDR_leiden),columns=["clus"])